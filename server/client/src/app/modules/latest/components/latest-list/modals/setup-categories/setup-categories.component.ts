  ...
  categoryTemplates = [
    {
      ...
      icon: 'attach_money',
      color: CategoriesColors.Salary,
      isSelected: false
    },
    {
      name: Categories.Car,
      icon: 'directions_car_filled',
      color: CategoriesColors.Car,
      isSelected: false
    },
    {
      name: Categories.Grocery,
      icon: 'shopping_cart',
      color: CategoriesColors.Grocery,
      isSelected: false
    },
    {
    ...
    },
    {
      ...
      icon: 'local_cafe',
      color: CategoriesColors.Coffee,
      isSelected: false
    },
    {
      name: Categories.Haircut,
      icon: 'content_cut',
      color: CategoriesColors.Haircut,
      isSelected: false
    },
    {
      name: Categories.MedicalSupplies,
      icon: 'medication',
      color: CategoriesColors.MedicalSupplies,
      isSelected: false
    },
    {
      name: Categories.Holiday,
      icon: 'holiday_village',
      color: CategoriesColors.Holiday,
      isSelected: false
    },
    {
      name: Categories.Utilities,
      icon: 'receipt',
      color: CategoriesColors.Utilities,
      isSelected: false
    },
    {
      name: Categories.Rent,
      icon: 'bedroom_parent',
      color: CategoriesColors.Rent,
      isSelected: false
    },
    {
      name: Categories.LoanPayments,
      icon: 'credit_score',
      color: CategoriesColors.LoanPayments,
      isSelected: false
    }
  ];

  constructor(
    public dialogRef: MatDialogRef<SetupCategoriesComponent>,
